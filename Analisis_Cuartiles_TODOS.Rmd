...
Luego tomamos la expresión de los genes **CA9** **HIF1A** y **LDH**, calculamos **cuartiles** según la definición:
...
Finalmente comparamos la expresión de los genes: "CD4", "FOXP3", "CD8B", "CD8A", "CD163", "ARG1", "CD274", "HIF1A", "SLC2A1", "EPAS1", "HK2", "PKM", "ALDOA", "PGK1", "PGM1", "ENO1", "LDHA", "SLC16A1", "SLC16A3" y "GPI" entre ambos grupos y producimos tablas y boxplots.
